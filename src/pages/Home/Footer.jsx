    ...
    <div>
      <footer className="relative w-full pt-6 lg:pt-0 text-white mt-16 lg:mt-32 bg-gradient-to-b from-[#1e1f27] to-[#380e16] ">
        <div className="w-full ">
            ...
            >
              <div className="flex gap-2 items-center text-white cursor-pointer">
                ...
                <h1 className="font-cinzel text-2xl lg:text-4xl font-semibold">
                  <span>Book</span>{" "}
                  <span className="text-[#FF7F56]">Vault</span>
                </h1>
              </div>
            </div>
              ...
              <div className=" w-10/12 mx-auto lg:mx-0 flex justify-center lg:justify-end ">
                <div className="max-w-sm text-center">
                  ...
                  <div className="space-y-1 font-cinzel">
                    <h4>456 XYZ Avenue, Suite 21, USA</h4>
                    <p>+1 123-456-7890</p>
            ...
            >
              <div className="  w-10/12 mx-auto lg:mx-0 flex justify-center lg:justify-start">
                <div className=" max-w-sm mb-5 py-8  lg:py-20  text-center">
                  ...
                  <p className="text-base font-medium mb-4 font-cinzel">
          ...
          <div className=" bg-gradient-to-l from-[#1a0f0f] to-[#100305] w-full flex justify-center items-center  border-blue-gray-50 py-4 ">
            <Typography className="text-xs md:text-sm text-center  font-normal text-white font-Inter  ">
              {currentYear} Copyright &copy; BooK Vault. All rights reserved.
            </Typography>
          </div>
        </div>
      </footer>
